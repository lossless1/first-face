        ...
        transition('* => LtoR', [
            sequence([
                ...
                group([
                    query(':enter', [
                        style({transform: 'translateX(-100%)'}),
                        animate('2.3s ease-in-out', style({transform: 'translateX(0%)'}))
                    ], {optional: true}),
                    query(':leave', [
                        style({transform: 'translateX(0%)'}),
                        animate('2.3s ease-in-out', style({transform: 'translateX(-100%)'}))
                    ], {optional: true}),
                ]),
